# Graph Report - src/content/wiki/ + raw/  (2026-04-20)

## Corpus Check
- Corpus is ~5,756 words - fits in a single context window. You may not need a graph.

## Summary
- 992 nodes · 1301 edges · 77 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 144 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_AST Language Extractors|AST Language Extractors]]
- [[_COMMUNITY_Graph Analysis Functions|Graph Analysis Functions]]
- [[_COMMUNITY_Benchmark & Skill Installers|Benchmark & Skill Installers]]
- [[_COMMUNITY_graphify Pipeline Core|graphify Pipeline Core]]
- [[_COMMUNITY_insong.net Site Architecture|insong.net Site Architecture]]
- [[_COMMUNITY_graphify Skill Variants|graphify Skill Variants]]
- [[_COMMUNITY_graphify Feature Concepts|graphify Feature Concepts]]
- [[_COMMUNITY_URL Ingest & Fetch|URL Ingest & Fetch]]
- [[_COMMUNITY_Community Index Pages|Community Index Pages]]
- [[_COMMUNITY_File Detection Module|File Detection Module]]
- [[_COMMUNITY_Game Server Data & Context|Game Server Data & Context]]
- [[_COMMUNITY_build-wiki-graph Script|build-wiki-graph Script]]
- [[_COMMUNITY_Claude Skill Feedback Loop|Claude Skill Feedback Loop]]
- [[_COMMUNITY_Semantic Extraction Cache|Semantic Extraction Cache]]
- [[_COMMUNITY_Wiki Operations (IngestLintQuery)|Wiki Operations (Ingest/Lint/Query)]]
- [[_COMMUNITY_SuperApps & iOS 위키|SuperApps & iOS 위키]]
- [[_COMMUNITY_Agent Workflow Tiers|Agent Workflow Tiers]]
- [[_COMMUNITY_SuperMusicNote Quiz UI|SuperMusicNote Quiz UI]]
- [[_COMMUNITY_Dev Process & Memory Discipline|Dev Process & Memory Discipline]]
- [[_COMMUNITY_iOS 영속성UI 패턴|iOS 영속성/UI 패턴]]
- [[_COMMUNITY_LLM Wiki Three-Layer Pattern|LLM Wiki Three-Layer Pattern]]
- [[_COMMUNITY_SuperTimers Detail Screen|SuperTimers Detail Screen]]
- [[_COMMUNITY_Whisper Transcription|Whisper Transcription]]
- [[_COMMUNITY_Redis Leaderboard Snapshot|Redis Leaderboard Snapshot]]
- [[_COMMUNITY_Git Hook Install|Git Hook Install]]
- [[_COMMUNITY_Leiden Clustering|Leiden Clustering]]
- [[_COMMUNITY_SuperTimers Home Onboarding|SuperTimers Home Onboarding]]
- [[_COMMUNITY_SuperFont My Fonts|SuperFont My Fonts]]
- [[_COMMUNITY_Wiki Pages Catalog|Wiki Pages Catalog]]
- [[_COMMUNITY_SuperTimers Running Patterns|SuperTimers Running Patterns]]
- [[_COMMUNITY_SuperMusicNote Home|SuperMusicNote Home]]
- [[_COMMUNITY_insong.net Memex & Wiki Stack|insong.net Memex & Wiki Stack]]
- [[_COMMUNITY_Code Quality & Git 원칙|Code Quality & Git 원칙]]
- [[_COMMUNITY_Graph Build & Validate|Graph Build & Validate]]
- [[_COMMUNITY_Wiki Article Generator|Wiki Article Generator]]
- [[_COMMUNITY_SuperFont Profile Install|SuperFont Profile Install]]
...
- [[_COMMUNITY_Wiki Auto-Ingest Flow|Wiki Auto-Ingest Flow]]
...
- [[_COMMUNITY_Raw Source Processing Pipeline|Raw Source Processing Pipeline]]
- [[_COMMUNITY_Game Server Request Context|Game Server Request Context]]
- [[_COMMUNITY_Getting Started & Wiki Workflow|Getting Started & Wiki Workflow]]
- [[_COMMUNITY_SuperFont File Add|SuperFont File Add]]
- [[_COMMUNITY_iOS Stack 2025|iOS Stack 2025]]
- [[_COMMUNITY_graphify Package Entry|graphify Package Entry]]
- [[_COMMUNITY_Wiki First Steps|Wiki First Steps]]
- [[_COMMUNITY_Wiki Lint & Tagging|Wiki Lint & Tagging]]
- [[_COMMUNITY_Logging Standards|Logging Standards]]
- [[_COMMUNITY_SwiftUI Sheet Pattern|SwiftUI Sheet Pattern]]
- [[_COMMUNITY_Code Scope Principles|Code Scope Principles]]
- [[_COMMUNITY_WikiSearch Component|WikiSearch Component]]
- [[_COMMUNITY_Tailwind cn() Helper|Tailwind cn() Helper]]
- [[_COMMUNITY_Blog Writing Reflections|Blog Writing Reflections]]
- [[_COMMUNITY_Skill Auto-Update Pitfall|Skill Auto-Update Pitfall]]
...
- [[_COMMUNITY_content config.ts|content config.ts]]
- [[_COMMUNITY_Git Feature Branch|Git Feature Branch]]
- [[_COMMUNITY_cn() helper node|cn() helper node]]
- [[_COMMUNITY_install-graphify script|install-graphify script]]
...
- [[_COMMUNITY_Leiden Clustering Concept|Leiden Clustering Concept]]
- [[_COMMUNITY_Relationship Tagging|Relationship Tagging]]
...
- [[_COMMUNITY_SuperFont Safari Allow|SuperFont Safari Allow]]
...
2. `graphify` - 27 edges
3. `_make_id()` - 26 edges
4. `Graph summary: 61 nodes · 70 edges · 12 communities (79% EXTRACTED)` - 20 edges
5. `graphify skill (OpenClaw)` - 19 edges
...
- `Wiki: 위키 시작하기` --semantically_similar_to--> `위키 시작하기 (obsidian)`  [INFERRED] [semantically similar]
  wiki-log.md → graphify-out/obsidian/위키 시작하기.md
- `Wiki: Redis 랭킹과 스냅샷 패턴` --semantically_similar_to--> `Blog leaderboard-snapshot`  [INFERRED] [semantically similar]
...
- **Four-stage processing pipeline** — graphify_deterministic_ast_pass, graphify_local_whisper, graphify_semantic_extraction, graphify_leiden_clustering [EXTRACTED 0.95]
- **Graphify output artifact set** — graphify_graph_html, graphify_graph_report_md, graphify_graph_json, graphify_obsidian_vault, graphify_wiki_output [EXTRACTED 0.90]
- **Core design principles** — graphify_privacy_first, graphify_token_efficient, graphify_no_embeddings, graphify_edge_tagging [EXTRACTED 0.90]

## Communities

### Community 0 - "AST Language Extractors"
Cohesion: 0.05
...
### Community 2 - "Benchmark & Skill Installers"
Cohesion: 0.06
...
### Community 3 - "graphify Pipeline Core"
Cohesion: 0.05
...
### Community 4 - "insong.net Site Architecture"
Cohesion: 0.06
...
### Community 5 - "graphify Skill Variants"
Cohesion: 0.05
...
### Community 6 - "graphify Feature Concepts"
Cohesion: 0.06
...
### Community 8 - "Community Index Pages"
Cohesion: 0.06
...
### Community 9 - "File Detection Module"
Cohesion: 0.1
...
### Community 10 - "Game Server Data & Context"
Cohesion: 0.08
...
### Community 11 - "build-wiki-graph Script"
Cohesion: 0.09
...
### Community 12 - "Claude Skill Feedback Loop"
Cohesion: 0.14
...
### Community 13 - "Semantic Extraction Cache"
Cohesion: 0.13
...
### Community 14 - "Wiki Operations (Ingest/Lint/Query)"
Cohesion: 0.16
...
### Community 16 - "Agent Workflow Tiers"
Cohesion: 0.12
...
### Community 20 - "LLM Wiki Three-Layer Pattern"
Cohesion: 0.16
...
### Community 21 - "SuperTimers Detail Screen"
Cohesion: 0.13
...
### Community 22 - "Whisper Transcription"
Cohesion: 0.21
...
### Community 23 - "Redis Leaderboard Snapshot"
Cohesion: 0.31
...
### Community 25 - "Leiden Clustering"
Cohesion: 0.22
...
### Community 26 - "SuperTimers Home Onboarding"
Cohesion: 0.17
...
### Community 27 - "SuperFont My Fonts"
Cohesion: 0.17
...
### Community 28 - "Wiki Pages Catalog"
Cohesion: 0.17
...
### Community 29 - "SuperTimers Running Patterns"
Cohesion: 0.2
...
### Community 30 - "SuperMusicNote Home"
Cohesion: 0.18
...
### Community 31 - "insong.net Memex & Wiki Stack"
Cohesion: 0.22
...
### Community 34 - "Wiki Article Generator"
Cohesion: 0.36
...
### Community 35 - "SuperFont Profile Install"
Cohesion: 0.25
...
### Community 36 - "insong.net Brand Identity"
Cohesion: 0.32
...
### Community 37 - "SuperTimers Edit Screen"
Cohesion: 0.32
...
### Community 38 - "SuperMusicNote Records"
Cohesion: 0.32
...
### Community 39 - "Wiki Auto-Ingest Flow"
Cohesion: 0.29
...
### Community 40 - "iOS App Development Community"
Cohesion: 0.57
...
### Community 41 - "SuperFont Google Fonts"
Cohesion: 0.29
...
### Community 42 - "Raw Source Processing Pipeline"
Cohesion: 0.4
...
### Community 43 - "Game Server Request Context"
Cohesion: 0.6
...
- **Thin community `env.d.ts`** (1 nodes): `env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `content config.ts`** (1 nodes): `config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Git Feature Branch`** (1 nodes): `Git feature-branch + PR workflow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `cn() helper node`** (1 nodes): `src/lib/utils.ts cn() helper (clsx + tailwind-merge)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `install-graphify script`** (1 nodes): `Step 6: scripts/install-graphify.sh (optional)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `graph.json Store`** (1 nodes): `graph.json Persistent Graph Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Leiden Clustering Concept`** (1 nodes): `Leiden Clustering (Community Detection)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Relationship Tagging`** (1 nodes): `Relationship Tagging (EXTRACTED/INFERRED/AMBIGUOUS)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `SuperFont Profile Downloaded`** (1 nodes): `SuperFont Profile Downloaded`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `SuperFont Safari Allow`** (1 nodes): `SuperFont Safari Allow Profile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `main()` connect `Benchmark & Skill Installers` to `AST Language Extractors`, `Graph Build & Validate`, `Graph Analysis Functions`, `build-wiki-graph Script`, `Leiden Clustering`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `_rebuild_code()` connect `Graph Analysis Functions` to `AST Language Extractors`, `Graph Build & Validate`, `Benchmark & Skill Installers`, `File Detection Module`, `Semantic Extraction Cache`, `Leiden Clustering`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `download_audio()` connect `Whisper Transcription` to `AST Language Extractors`, `URL Ingest & Fetch`?**
...
- **Should `AST Language Extractors` be split into smaller, more focused modules?**
