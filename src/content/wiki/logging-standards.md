---
title: "옵저버빌리티 & 로깅 표준"
description: "Claude Code 환경에서 스크립트, 테스트, 훅이 생성하는 로그 포맷과 읽기 규율"
publishDate: 2026-04-21
updatedDate: 2026-04-21
tags: ["logging", "observability", "Claude", "workflow", "tooling"]
draft: false
sources: ["raw/logging-standards.md"]
---
...
- 파일 상단에 `set -euo pipefail` 추가
- `COMPONENT` 환경변수로 component 명시
...
| Shell 스크립트 후 | stdout/stderr 내용 있으면 읽기; `$? == 0`만으로 성공 추론 금지 |
...
- [[code-quality]] — 파괴적 우회(`--no-verify`) 금지 원칙과 연결
- [[claude-workflow-tiers]] — 티어별 빌드/테스트 파이프라인
